    ...
    ['$scope', '$http', '$filter',
        function($scope, $http, $filter){
                  ...
                  if(creditCheck(seances)){
                    ...
                    if(seances[n_seance].demande == "High"){
                      if(ctrl.credit > 1){
                        ...
                        window.alert("Vous n'avez pas assez de crédit pour la séance.");
                      }
                    }else{
                      bookById(id, seances, list_films);
                      ctrl.credit--;
                    ...
                    window.alert("Vous avez déjà utilisé votre crédit aujourd'hui. Il vous reste " + ctrl.credit + " crédit à utiliser sur les autres jours. Nous vous rappelons que vous avez le droit à un credit par jour.");
                  }
                }else{
                  window.alert("Vous avez utilisé tout votre crédit pour ce festival. Pour pouvoir réserver cette séance, veuillez annuler une de vos réservations.")
                }
            }
            ...
            ctrl.cancel = function(id, date){
                ...
                var confirmation = window.confirm("Etes-vous certains de vouloir annuler cette réservation ?");
